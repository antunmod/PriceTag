...
public class RepositoryTest {
	...
	public void testStoreSpecific() {
		StoreSpecific storeSpecific = storeSpecificRepository.findByStoreSpecificId(JURISICEVA_ULICA_13_STORE_SPECIFIC_ID);
	...
	public void testProductSpecific() {
		ProductSpecific productSpecific = productSpecificRepository.findByProductSpecificId(SUNFLOWER_OIL_PRODUCT_SPECIFIC_ID);
